...
$GLOBALS['TL_LANG']['tl_module']['customLanguageText'] = array('Sprachtexte', 'Bitte geben Sie einen Ersatz für jede Sprache ein.');


/**
 * References
 */
$GLOBALS['TL_LANG']['tl_module']['customLanguageText']['value']   = 'Sprachkürzel (klein)';
$GLOBALS['TL_LANG']['tl_module']['customLanguageText']['label']   = 'Ersatztext';
